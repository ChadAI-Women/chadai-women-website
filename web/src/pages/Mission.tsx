...
const About = () => {
  return (
    <>
      ...
      {/* Valeurs */}
      <section id="valeurs" className="scroll-mt-24 py-20 bg-background overflow-hidden">
        <div className="section-container">
          <div className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr] lg:items-start mb-14">
            <div>
              <span className="inline-flex items-center gap-3 text-secondary-ink font-semibold uppercase tracking-widest text-sm mb-4">
                <FlagDash size="sm" />
                Nos Valeurs
              ...
              <h2 className="font-display text-3xl md:text-5xl font-bold text-primary leading-tight">
                Ce qui guide chacune de nos initiatives
              </h2>
            </div>
            <p className="text-muted-foreground text-lg leading-relaxed max-w-2xl">
              Ces principes donnent le ton de nos formations, de notre mentorat
              et de nos collaborations : une IA accessible, exigeante et utile
            ...
            {valeurs.map((v, i) => (
              <motion.div
                ...
                className={[
                  ...
                  i === 0 && "lg:col-span-2 bg-primary text-primary-foreground md:-rotate-1",
                  i === 1 && "lg:col-span-2 bg-secondary text-secondary-foreground md:rotate-1",
                  i === 2 && "lg:col-span-2 bg-card text-foreground border border-primary/10",
                  i === 3 && "lg:col-span-3 bg-destructive text-destructive-foreground md:rotate-1",
                  i === 4 && "lg:col-span-3 bg-muted text-foreground md:-rotate-1 border border-primary/10",
                ]
                  .filter(Boolean)
                  .join(" ")}
              >
                <div className="mb-8 flex items-center justify-between gap-4">
                  <span
                    className={[
                      "inline-flex rounded-full px-4 py-1.5 text-xs font-bold uppercase tracking-widest",
                      i === 0 && "bg-primary-foreground/15 text-primary-foreground",
                      i === 1 && "bg-primary/10 text-primary",
                      i === 2 && "bg-secondary/15 text-secondary",
                      i === 3 && "bg-destructive-foreground/15 text-destructive-foreground",
                      i === 4 && "bg-background text-primary",
                    ]
                      .filter(Boolean)
                      .join(" ")}
                  >
                  ...
                  <span
                    className={[
                      "font-display text-5xl font-black leading-none opacity-15",
                      i === 2 || i === 4 ? "text-primary" : "text-current",
                    ]
                      .filter(Boolean)
                      .join(" ")}
                  >
                ...
                <div
                  className={[
                    ...
                    i === 0 && "bg-primary-foreground/15",
                    i === 1 && "bg-primary/10",
                    i === 2 && "bg-secondary/15",
                    i === 3 && "bg-destructive-foreground/15",
                    i === 4 && "bg-background",
                  ]
                    .filter(Boolean)
                    .join(" ")}
                >
                  <v.icon
                    className={[
                      ...
                      i === 1 && "text-primary",
                      i === 2 && "text-secondary",
                      i === 3 && "text-destructive-foreground",
                      i === 4 && "text-primary",
                    ]
                      .filter(Boolean)
                      .join(" ")}
                ...
                <p
                  className={[
                    ...
                    i === 0 && "text-primary-foreground/85",
                    i === 1 && "text-secondary-foreground/85",
                    i === 2 && "text-muted-foreground",
                    i === 3 && "text-destructive-foreground/85",
